...
def generateRandomRoutes2():
    ...
    vehicle_types_definition = '''
        ...
        <vType vClass="pedestrian" id="ped0" guiShape="pedestrian" speedFactor="0.7" width="0.62" length="0.39" height="1.65" color="255,0,128" />
        <vType vClass="pedestrian" id="ped1" guiShape="pedestrian" speedFactor="0.7" width="0.65" length="0.41" height="1.73" color="255,165,0" />
        <vType vClass="pedestrian" id="ped2" guiShape="pedestrian" speedFactor="1.0" width="0.61" length="0.37" height="1.60" color="255,128,128" />
        <vType vClass="pedestrian" id="ped3" guiShape="pedestrian" speedFactor="1.0" width="0.66" length="0.43" height="1.75" color="144,238,144" />
        <vType vClass="pedestrian" id="ped4" guiShape="pedestrian" speedFactor="1.3" width="0.64" length="0.40" height="1.68" color="128,128,255" />
        <vType vClass="pedestrian" id="ped5" guiShape="pedestrian" speedFactor="1.3" width="0.63" length="0.42" height="1.70" color="100,87,240" />
    '''
...
def getSimStatebyImage():    
    ...
    traci.gui.screenshot(viewID=traci.gui.DEFAULT_VIEW, filename=screenshot_path)
 ...
 # 3. Preprocess the image
    # Resize the image to match the input shape of the CNN (e.g., 80x80)
    processed_image = image.resize((80, 80))
    
   # Optionally convert to grayscale to reduce input complexity
    processed_image = processed_image.convert('L')  # 'L' mode is grayscale
    ...
    return processed_image   # (80, 80, 1) is returned!
